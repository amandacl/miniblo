import { Text, FormControl, Center, FormLabel, Input, Flex, Heading, Box, Button, Textarea } from '@chakra-ui/react'
    ...
    return (
        ...
        <Flex w="full" direction='column' align="center" justify="center" m='3' bgColor='#F8F8FF'>
            <Box p={2} m={2} align='center'>
                <Heading fontSize='22px' mb='3'>Criar post</Heading>
                <Text mb='2'>Escreva sobre o que quiser e compartilhe o seu conhecimento!</Text>
            </Box>
